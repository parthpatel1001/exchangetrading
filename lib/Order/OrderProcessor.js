...
export class OrderProcessor {
    constructor(ExchangeManager) {
        ...
        this.processLinkedOrder = (order1,order2) => {
            ...
            var ex1 = this.exchangeManager.getExchange(order1.getExchangeId()),
                ex2 = this.exchangeManager.getExchange(order2.getExchangeId());
    ...
    adjustBalance(order,exchange) {
        ...
        if(order.isBuyOrder()) {
            ...
            this.balanceTracker.incrementBTCBalance(exchange,order.getAmount());
        }
        if(order.isSellOrder()) {
            this.balanceTracker.decrementBTCBalance(exchange,order.getAmount());
