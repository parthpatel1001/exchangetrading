...
export class Arbiter {
    ...
    processOpportunities(orderBookTop) {
        let maths = [];
        ...
        if(!orderBookTop || !checkOrderBookTop(orderBookTop)) {
            return this.OrderGenerator.err(orderBookTop);
        }
        ...
        if(maxArbObj != null) {
            return this.OrderGenerator.generateOrder(
        ...
        return this.OrderGenerator.noOrder(orderBookTop, maths);
    };
}
