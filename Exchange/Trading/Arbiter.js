 ...
 */
var num = require('num');
var Arbiter = function(thresholdIn) {

    var threshold = thresholdIn;
     ...
     * @param Trader
     */
    this.arbTwoExchanges = function(OrderBookManager,ExchangeManager,Trader)
    {
        OrderBookManager.subscribeToOrderBooks(function(bookTop){
            return getArbOppurtunities(bookTop,
