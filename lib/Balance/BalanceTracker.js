 ...
 */
let setBalanceToRedis = function(balanceIn) {
 ...
 * @param exid
 */
let getExSpecificBalanceKey = function(balKey,exid) {
...
var BalanceTracker = function(){
    ...
    constructor() {
        ...
        for(; i < len; i++) {
            exchanges[i].getBalance(function(err,result){
                if(err) {
                    return err;
                }
     ...
     */
    retrieveBalance(Exchange,callback){
     ...
     */
    incrementUSDBalance(Exchange,amount) {
     ...
     * @param amount
     */
    decrementUSDBalance(Exchange,amount) {
        this.retrieveBalance(Exchange,function(err,resultBalance){
            if(err){
     ...
     * @param amount
     */
    incrementBTCBalance(Exchange,amount) {
        this.retrieveBalance(Exchange,function(err,resultBalance){
            if(err){
     ...
     * @param amount
     */
    decrementBTCBalance(Exchange,amount) {
        this.retrieveBalance(Exchange,function(err,resultBalance){
            if(err){
