...
let makeSureEnoughBalance = (balance,order,exchange) => {
    var cost, bal, avail_bal, cmp, cmp_bool;
    ...
    if(order instanceof BuyOrder) {
        ...
        cmp_bool = cmp === 1;
        console.info("OrderProcessor.makeSureEnoughBalance.BuyOrder: \t {cost:%s,bal:%s,avail_bal:%s,cmp:%s,cmp_bool:%s}",cost,bal.toString(),avail_bal.toString(),cmp,cmp_bool);
        return cmp_bool;
    }
        ...
        console.info("OrderProcessor.makeSureEnoughBalance.SellOrder: \t {cost:%s,bal:%s,avail_bal:%s,cmp:%s,cmp_bool:%s}",cost,bal.toString(),avail_bal.toString(),cmp,cmp_bool);
