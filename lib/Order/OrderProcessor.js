 ...
 * @constructor
 */
var OrderProcessor = function(ExchangeManager,BalanceTracker,notifier){
        ...
        async.parallel([
            ...
            async.parallel([
                ...
                function(err,results){
                    ...
                    // TODO fire 2 ORDER_PROCEESED events so an OrderTracker process can go and monitor the status of these orders
                    if(err) {
                        console.log(err);
                        throw err;
                    }
