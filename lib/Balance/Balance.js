...
var Balance = function(balanceIn){
    ...
    this.setUSDAvailable = function(amount){ balanceIn.usd_avail = amount.toString();};
    this.setBTCAvailable = function(amount){ balanceIn.btc_avail = amount.toString();};
    this.getExchangeId = function(){ return balanceIn.exchangeId; };
    this.serialize = function(){ return JSON.stringify(balanceIn);};
};
