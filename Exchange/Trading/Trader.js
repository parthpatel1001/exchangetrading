var Trader = function() {
    ...
    this.trade = function(ex1,ex2,price1,price2,amount)
    {
        ...
        var test5 = price1.mul(amount).add(price2.mul(amount)).mul(.005);
        var test6 = 'Profit: ($'+test3.set_precision(2)+','+test4.set_precision(2)+'%) Fee: ($'+test5.set_precision(2).toString()+',.5%)';
